...
static void mult_nored(uint32_t *restrict r, const felem a, const felem b) {
  ...
  t = carry + ((uint64_t)a[13]) * b[18] + ((uint64_t)a[14]) * b[17] +
...
static void sqr_nored(uint32_t *restrict r, const felem a) {
  ...
  t = carry + ((uint64_t)(a[0] << 1)) * a[11] +
      ...
      ((uint64_t)(a[3] << 1)) * a[8] + ((uint64_t)(a[4] << 1)) * a[7] +
      ((uint64_t)(a[5] << 1)) * a[6];
  ...
  t = carry + ((uint64_t)(a[0] << 1)) * a[12] +
      ...
      ((uint64_t)(a[3] << 1)) * a[9] + ((uint64_t)(a[4] << 1)) * a[8] +
      ((uint64_t)(a[5] << 1)) * a[7] + ((uint64_t)a[6]) * a[6];
  ...
  t = carry + ((uint64_t)(a[0] << 1)) * a[13] +
      ...
      ((uint64_t)(a[3] << 1)) * a[10] + ((uint64_t)(a[4] << 1)) * a[9] +
      ((uint64_t)(a[5] << 1)) * a[8] + ((uint64_t)(a[6] << 1)) * a[7];
  ...
  t = carry + ((uint64_t)(a[0] << 1)) * a[14] +
      ...
      ((uint64_t)(a[3] << 1)) * a[11] + ((uint64_t)(a[4] << 1)) * a[10] +
      ((uint64_t)(a[5] << 1)) * a[9] + ((uint64_t)(a[6] << 1)) * a[8] +
      ((uint64_t)a[7]) * a[7];
  ...
  t = carry + ((uint64_t)(a[0] << 1)) * a[15] +
      ...
      ((uint64_t)(a[3] << 1)) * a[12] + ((uint64_t)(a[4] << 1)) * a[11] +
      ((uint64_t)(a[5] << 1)) * a[10] + ((uint64_t)(a[6] << 1)) * a[9] +
      ((uint64_t)(a[7] << 1)) * a[8];
  ...
  t = carry + ((uint64_t)(a[0] << 1)) * a[16] +
      ...
      ((uint64_t)(a[3] << 1)) * a[13] + ((uint64_t)(a[4] << 1)) * a[12] +
      ((uint64_t)(a[5] << 1)) * a[11] + ((uint64_t)(a[6] << 1)) * a[10] +
      ((uint64_t)(a[7] << 1)) * a[9] + ((uint64_t)a[8]) * a[8];
  ...
  t = carry + ((uint64_t)(a[0] << 1)) * a[17] +
      ...
      ((uint64_t)(a[3] << 1)) * a[14] + ((uint64_t)(a[4] << 1)) * a[13] +
      ((uint64_t)(a[5] << 1)) * a[12] + ((uint64_t)(a[6] << 1)) * a[11] +
      ((uint64_t)(a[7] << 1)) * a[10] + ((uint64_t)(a[8] << 1)) * a[9];
  ...
  t = carry + ((uint64_t)(a[0] << 1)) * a[18] +
      ...
      ((uint64_t)(a[3] << 1)) * a[15] + ((uint64_t)(a[4] << 1)) * a[14] +
      ((uint64_t)(a[5] << 1)) * a[13] + ((uint64_t)(a[6] << 1)) * a[12] +
      ((uint64_t)(a[7] << 1)) * a[11] + ((uint64_t)(a[8] << 1)) * a[10] +
      ((uint64_t)a[9]) * a[9];
  ...
  t = carry + ((uint64_t)(a[1] << 1)) * a[18] +
      ...
      ((uint64_t)(a[4] << 1)) * a[15] + ((uint64_t)(a[5] << 1)) * a[14] +
      ((uint64_t)(a[6] << 1)) * a[13] + ((uint64_t)(a[7] << 1)) * a[12] +
      ((uint64_t)(a[8] << 1)) * a[11] + ((uint64_t)(a[9] << 1)) * a[10];
  ...
  t = carry + ((uint64_t)(a[2] << 1)) * a[18] +
      ...
      ((uint64_t)(a[5] << 1)) * a[15] + ((uint64_t)(a[6] << 1)) * a[14] +
      ((uint64_t)(a[7] << 1)) * a[13] + ((uint64_t)(a[8] << 1)) * a[12] +
      ((uint64_t)(a[9] << 1)) * a[11] + ((uint64_t)a[10]) * a[10];
  ...
  t = carry + ((uint64_t)(a[3] << 1)) * a[18] +
      ...
      ((uint64_t)(a[6] << 1)) * a[15] + ((uint64_t)(a[7] << 1)) * a[14] +
      ((uint64_t)(a[8] << 1)) * a[13] + ((uint64_t)(a[9] << 1)) * a[12] +
  ...
  t = carry + ((uint64_t)(a[4] << 1)) * a[18] +
      ((uint64_t)(a[5] << 1)) * a[17] + ((uint64_t)(a[6] << 1)) * a[16] +
      ((uint64_t)(a[7] << 1)) * a[15] + ((uint64_t)(a[8] << 1)) * a[14] +
      ((uint64_t)(a[9] << 1)) * a[13] + ((uint64_t)(a[10] << 1)) * a[12] +
      ((uint64_t)a[11]) * a[11];
  ...
  t = carry + ((uint64_t)(a[5] << 1)) * a[18] +
      ((uint64_t)(a[6] << 1)) * a[17] + ((uint64_t)(a[7] << 1)) * a[16] +
      ((uint64_t)(a[8] << 1)) * a[15] + ((uint64_t)(a[9] << 1)) * a[14] +
      ((uint64_t)(a[10] << 1)) * a[13] + ((uint64_t)(a[11] << 1)) * a[12];
  ...
  t = carry + ((uint64_t)(a[6] << 1)) * a[18] +
      ...
      ((uint64_t)(a[9] << 1)) * a[15] + ((uint64_t)(a[10] << 1)) * a[14] +
      ((uint64_t)(a[11] << 1)) * a[13] + ((uint64_t)a[12]) * a[12];

  carry = t >> 28;

  r[24] = t - (carry << 28);

  t = carry + ((uint64_t)(a[7] << 1)) * a[18] +
      ((uint64_t)(a[8] << 1)) * a[17] + ((uint64_t)(a[9] << 1)) * a[16] +
      ((uint64_t)(a[10] << 1)) * a[15] + ((uint64_t)(a[11] << 1)) * a[14] +
  ...
  t = carry + ((uint64_t)(a[8] << 1)) * a[18] +
      ...
      ((uint64_t)(a[11] << 1)) * a[15] + ((uint64_t)(a[12] << 1)) * a[14] +
      ((uint64_t)a[13]) * a[13];
  ...
  t = carry + ((uint64_t)(a[9] << 1)) * a[18] +
      ...
      ((uint64_t)(a[12] << 1)) * a[15] + ((uint64_t)(a[13] << 1)) * a[14];
  ...
  t = carry + ((uint64_t)(a[10] << 1)) * a[18] +
      ...
      ((uint64_t)(a[13] << 1)) * a[15] + ((uint64_t)a[14]) * a[14];

  carry = t >> 28;

  r[28] = t - (carry << 28);

  t = carry + ((uint64_t)(a[11] << 1)) * a[18] +
      ((uint64_t)(a[12] << 1)) * a[17] + ((uint64_t)(a[13] << 1)) * a[16] +
...
static void multred(felem r, uint32_t *restrict prod) {
  ...
  // 2^(30).
  for (int i = 0; i < 19; i++) {
    prod[i] += (prod[19 + i] & two17m1) << 11; //<2^29
    prod[i + 1] += prod[19 + i] >> 17;         // still <2^29
  }
  for (int i = 0; i < 19; i++) {
    r[i] = prod[i];
  }
