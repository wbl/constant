...
static void sqr_nored(uint64_t r[38], const felem a) {
  r[0] = 0 + ((uint64_t)a[0]) * a[0];

  r[1] = 0 + ((uint64_t)a[0] << 1) * a[1];

  r[2] = 0 + ((uint64_t)a[0] << 1) * a[2] + ((uint64_t)a[1]) * a[1];

  r[3] = 0 + ((uint64_t)a[0] << 1) * a[3] + ((uint64_t)a[1] << 1) * a[2];

  r[4] = 0 + ((uint64_t)a[0] << 1) * a[4] + ((uint64_t)a[1] << 1) * a[3] +
         ((uint64_t)a[2]) * a[2];

  r[5] = 0 + ((uint64_t)a[0] << 1) * a[5] + ((uint64_t)a[1] << 1) * a[4] +
         ((uint64_t)a[2] << 1) * a[3];

  r[6] = 0 + ((uint64_t)a[0] << 1) * a[6] + ((uint64_t)a[1] << 1) * a[5] +
         ((uint64_t)a[2] << 1) * a[4] + ((uint64_t)a[3]) * a[3];

  r[7] = 0 + ((uint64_t)a[0] << 1) * a[7] + ((uint64_t)a[1] << 1) * a[6] +
         ((uint64_t)a[2] << 1) * a[5] + ((uint64_t)a[3] << 1) * a[4];

  r[8] = 0 + ((uint64_t)a[0] << 1) * a[8] + ((uint64_t)a[1] << 1) * a[7] +
         ((uint64_t)a[2] << 1) * a[6] + ((uint64_t)a[3] << 1) * a[5] +
         ((uint64_t)a[4]) * a[4];

  r[9] = 0 + ((uint64_t)a[0] << 1) * a[9] + ((uint64_t)a[1] << 1) * a[8] +
         ((uint64_t)a[2] << 1) * a[7] + ((uint64_t)a[3] << 1) * a[6] +
         ((uint64_t)a[4] << 1) * a[5];

  r[10] = 0 + ((uint64_t)a[0] << 1) * a[10] + ((uint64_t)a[1] << 1) * a[9] +
          ((uint64_t)a[2] << 1) * a[8] + ((uint64_t)a[3] << 1) * a[7] +
          ((uint64_t)a[4] << 1) * a[6] + ((uint64_t)a[5]) * a[5];

  r[11] = 0 + ((uint64_t)a[0] << 1) * a[11] + ((uint64_t)a[1] << 1) * a[10] +
          ((uint64_t)a[2] << 1) * a[9] + ((uint64_t)a[3] << 1) * a[8] +
          ((uint64_t)a[4] << 1) * a[7] + ((uint64_t)a[5] << 1) * a[6];

  r[12] = 0 + ((uint64_t)a[0] << 1) * a[12] + ((uint64_t)a[1] << 1) * a[11] +
          ((uint64_t)a[2] << 1) * a[10] + ((uint64_t)a[3] << 1) * a[9] +
          ((uint64_t)a[4] << 1) * a[8] + ((uint64_t)a[5] << 1) * a[7] +
          ((uint64_t)a[6]) * a[6];

  r[13] = 0 + ((uint64_t)a[0] << 1) * a[13] + ((uint64_t)a[1] << 1) * a[12] +
          ((uint64_t)a[2] << 1) * a[11] + ((uint64_t)a[3] << 1) * a[10] +
          ((uint64_t)a[4] << 1) * a[9] + ((uint64_t)a[5] << 1) * a[8] +
          ((uint64_t)a[6] << 1) * a[7];

  r[14] = 0 + ((uint64_t)a[0] << 1) * a[14] + ((uint64_t)a[1] << 1) * a[13] +
          ((uint64_t)a[2] << 1) * a[12] + ((uint64_t)a[3] << 1) * a[11] +
          ((uint64_t)a[4] << 1) * a[10] + ((uint64_t)a[5] << 1) * a[9] +
          ((uint64_t)a[6] << 1) * a[8] + ((uint64_t)a[7]) * a[7];

  r[15] = 0 + ((uint64_t)a[0] << 1) * a[15] + ((uint64_t)a[1] << 1) * a[14] +
          ((uint64_t)a[2] << 1) * a[13] + ((uint64_t)a[3] << 1) * a[12] +
          ((uint64_t)a[4] << 1) * a[11] + ((uint64_t)a[5] << 1) * a[10] +
          ((uint64_t)a[6] << 1) * a[9] + ((uint64_t)a[7] << 1) * a[8];

  r[16] = 0 + ((uint64_t)a[0] << 1) * a[16] + ((uint64_t)a[1] << 1) * a[15] +
          ((uint64_t)a[2] << 1) * a[14] + ((uint64_t)a[3] << 1) * a[13] +
          ((uint64_t)a[4] << 1) * a[12] + ((uint64_t)a[5] << 1) * a[11] +
          ((uint64_t)a[6] << 1) * a[10] + ((uint64_t)a[7] << 1) * a[9] +
          ((uint64_t)a[8]) * a[8];

  r[17] = 0 + ((uint64_t)a[0] << 1) * a[17] + ((uint64_t)a[1] << 1) * a[16] +
          ((uint64_t)a[2] << 1) * a[15] + ((uint64_t)a[3] << 1) * a[14] +
          ((uint64_t)a[4] << 1) * a[13] + ((uint64_t)a[5] << 1) * a[12] +
          ((uint64_t)a[6] << 1) * a[11] + ((uint64_t)a[7] << 1) * a[10] +
          ((uint64_t)a[8] << 1) * a[9];

  r[18] = 0 + ((uint64_t)a[0] << 1) * a[18] + ((uint64_t)a[1] << 1) * a[17] +
          ((uint64_t)a[2] << 1) * a[16] + ((uint64_t)a[3] << 1) * a[15] +
          ((uint64_t)a[4] << 1) * a[14] + ((uint64_t)a[5] << 1) * a[13] +
          ((uint64_t)a[6] << 1) * a[12] + ((uint64_t)a[7] << 1) * a[11] +
          ((uint64_t)a[8] << 1) * a[10] + ((uint64_t)a[9]) * a[9];

  r[19] = 0 + ((uint64_t)a[1] << 1) * a[18] + ((uint64_t)a[2] << 1) * a[17] +
          ((uint64_t)a[3] << 1) * a[16] + ((uint64_t)a[4] << 1) * a[15] +
          ((uint64_t)a[5] << 1) * a[14] + ((uint64_t)a[6] << 1) * a[13] +
          ((uint64_t)a[7] << 1) * a[12] + ((uint64_t)a[8] << 1) * a[11] +
          ((uint64_t)a[9] << 1) * a[10];

  r[20] = 0 + ((uint64_t)a[2] << 1) * a[18] + ((uint64_t)a[3] << 1) * a[17] +
          ((uint64_t)a[4] << 1) * a[16] + ((uint64_t)a[5] << 1) * a[15] +
          ((uint64_t)a[6] << 1) * a[14] + ((uint64_t)a[7] << 1) * a[13] +
          ((uint64_t)a[8] << 1) * a[12] + ((uint64_t)a[9] << 1) * a[11] +
          ((uint64_t)a[10]) * a[10];

  r[21] = 0 + ((uint64_t)a[3] << 1) * a[18] + ((uint64_t)a[4] << 1) * a[17] +
          ((uint64_t)a[5] << 1) * a[16] + ((uint64_t)a[6] << 1) * a[15] +
          ((uint64_t)a[7] << 1) * a[14] + ((uint64_t)a[8] << 1) * a[13] +
          ((uint64_t)a[9] << 1) * a[12] + ((uint64_t)a[10] << 1) * a[11];

  r[22] = 0 + ((uint64_t)a[4] << 1) * a[18] + ((uint64_t)a[5] << 1) * a[17] +
          ((uint64_t)a[6] << 1) * a[16] + ((uint64_t)a[7] << 1) * a[15] +
          ((uint64_t)a[8] << 1) * a[14] + ((uint64_t)a[9] << 1) * a[13] +
          ((uint64_t)a[10] << 1) * a[12] + ((uint64_t)a[11]) * a[11];

  r[23] = 0 + ((uint64_t)a[5] << 1) * a[18] + ((uint64_t)a[6] << 1) * a[17] +
          ((uint64_t)a[7] << 1) * a[16] + ((uint64_t)a[8] << 1) * a[15] +
          ((uint64_t)a[9] << 1) * a[14] + ((uint64_t)a[10] << 1) * a[13] +
          ((uint64_t)a[11] << 1) * a[12];

  r[24] = 0 + ((uint64_t)a[6] << 1) * a[18] + ((uint64_t)a[7] << 1) * a[17] +
          ((uint64_t)a[8] << 1) * a[16] + ((uint64_t)a[9] << 1) * a[15] +
          ((uint64_t)a[10] << 1) * a[14] + ((uint64_t)a[11] << 1) * a[13] +
          ((uint64_t)a[12]) * a[12];

  r[25] = 0 + ((uint64_t)a[7] << 1) * a[18] + ((uint64_t)a[8] << 1) * a[17] +
          ((uint64_t)a[9] << 1) * a[16] + ((uint64_t)a[10] << 1) * a[15] +
          ((uint64_t)a[11] << 1) * a[14] + ((uint64_t)a[12] << 1) * a[13];

  r[26] = 0 + ((uint64_t)a[8] << 1) * a[18] + ((uint64_t)a[9] << 1) * a[17] +
          ((uint64_t)a[10] << 1) * a[16] + ((uint64_t)a[11] << 1) * a[15] +
          ((uint64_t)a[12] << 1) * a[14] + ((uint64_t)a[13]) * a[13];

  r[27] = 0 + ((uint64_t)a[9] << 1) * a[18] + ((uint64_t)a[10] << 1) * a[17] +
          ((uint64_t)a[11] << 1) * a[16] + ((uint64_t)a[12] << 1) * a[15] +
          ((uint64_t)a[13] << 1) * a[14];

  r[28] = 0 + ((uint64_t)a[10] << 1) * a[18] + ((uint64_t)a[11] << 1) * a[17] +
          ((uint64_t)a[12] << 1) * a[16] + ((uint64_t)a[13] << 1) * a[15] +
          ((uint64_t)a[14]) * a[14];

  r[29] = 0 + ((uint64_t)a[11] << 1) * a[18] + ((uint64_t)a[12] << 1) * a[17] +
          ((uint64_t)a[13] << 1) * a[16] + ((uint64_t)a[14] << 1) * a[15];

  r[30] = 0 + ((uint64_t)a[12] << 1) * a[18] + ((uint64_t)a[13] << 1) * a[17] +
          ((uint64_t)a[14] << 1) * a[16] + ((uint64_t)a[15]) * a[15];

  r[31] = 0 + ((uint64_t)a[13] << 1) * a[18] + ((uint64_t)a[14] << 1) * a[17] +
          ((uint64_t)a[15] << 1) * a[16];

  r[32] = 0 + ((uint64_t)a[14] << 1) * a[18] + ((uint64_t)a[15] << 1) * a[17] +
          ((uint64_t)a[16]) * a[16];

  r[33] = 0 + ((uint64_t)a[15] << 1) * a[18] + ((uint64_t)a[16] << 1) * a[17];

  r[34] = 0 + ((uint64_t)a[16] << 1) * a[18] + ((uint64_t)a[17]) * a[17];

  r[35] = 0 + ((uint64_t)a[17] << 1) * a[18];

  r[36] = 0 + ((uint64_t)a[18]) * a[18];
